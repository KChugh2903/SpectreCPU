...
VL_INLINE_OPT void VTop_StoreQueue___ico_sequent__TOP__Top__soc__core__sq__0(VTop_StoreQueue* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTop_StoreQueue___ico_sequent__TOP__Top__soc__core__sq__0\n"); );
